  ...
  (s = (function () {
    function e(e, t) {
      for (var s = 0; s < h.length; s++)
        if (h[s].className === e)
          return "undefined" != typeof t && (h[s] = t), h[s];
      return !1;
    }
    function t(e) {
    ...
    function n(i, n) {
      ...
      for (var r, _ = 0, d = l.length; _ < d; _++) {
        ...
        "CustomEvent" in window && "function" == typeof window.CustomEvent
          ? (m = new CustomEvent("mdl-componentupgraded", {
              bubbles: !0,
              cancelable: !1,
            }))
      ...
      for (var t, s = 0, i = e.length; s < i; s++)
        (t = e[s]),
          t instanceof HTMLElement &&
            (n(t), t.children.length > 0 && a(t.children));
    }
    function l(t) {
    ...
    function _(e) {
      if (e) {
        ...
        var n;
        "CustomEvent" in window && "function" == typeof window.CustomEvent
          ? (n = new CustomEvent("mdl-componentdowngraded", {
              bubbles: !0,
              cancelable: !1,
            }))
